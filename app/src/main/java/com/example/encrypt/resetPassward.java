            ...
            public void onClick(View view) {
                ...
                if(pwd.equals(oldpassword))
                {
                    ...
                    if(newpassword.equals(cnfpassword))
                    {
                        ...
                        Toast.makeText(resetPassward.this,"Updated Successfully!!",Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    else
                    {
                        Toast.makeText(resetPassward.this," password does not match",Toast.LENGTH_SHORT).show();
